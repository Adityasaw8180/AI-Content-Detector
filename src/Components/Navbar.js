    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
            <div className="container-fluid">
                <a className="navbar-brand" href="/"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" className="bi bi-robot" viewBox="0 0 16 16" id="weblogo">
                ...
                </svg><strong className='website-heading'>Generative AI Detection</strong></a>
                ...
                {/* <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button className="gitbutton" onClick={redirectToGithub}>

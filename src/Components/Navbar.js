  ...
  <nav className="navbar navbar-expand-lg navbar-light bg-light shadow-sm py-3 custom-navbar">
    <div className="container-fluid">
      ...
      <a className="navbar-brand d-flex align-items-center" href="/">
        <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} fill="currentColor" className="bi bi-robot me-2" viewBox="0 0 16 16">
      ...
      <div className="collapse navbar-collapse" id="navbarLinks">
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          {/* <li className="nav-item">
            <a className="nav-link about-link" href="/AboutUs.html">About Us</a>
          </li> */}
        </ul>
      </div>
    </div>
